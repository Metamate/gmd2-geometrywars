...
namespace GeometryWars4.Components.Visuals;

// Spawns fire particles behind a moving entity.
public sealed class ExhaustFire : Component
{
    ...
    public ExhaustFire(IParticleSystem<ParticleState> particles, FrameInfo frame, Texture2D lineParticle, Texture2D glow)
    {
    ...
    public override void PostUpdate(Entity owner)
    {
        ...
        _particles.CreateParticle(_lineParticle, pos, Color.White * alpha, 60f, new Vector2(0.5f, 1),
            ParticleState.StableTrail(velMid));
        ...
        _particles.CreateParticle(_lineParticle, pos, Color.White * alpha, 60f, new Vector2(0.5f, 1),
            ParticleState.StableTrail(vel1));
        _particles.CreateParticle(_lineParticle, pos, Color.White * alpha, 60f, new Vector2(0.5f, 1),
