...
public sealed class PlayerRespawnBehaviour : Component
{
    ...
    public PlayerRespawnBehaviour(IScoreTracker score, IParticleSystem<ParticleState> particles, IGridField grid, Texture2D lineParticle)
    {
        _score = score;
